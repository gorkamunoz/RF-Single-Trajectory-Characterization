function data = load_fbm(num_traj, alpha_range, t_max, ratio_aN, path_trajectories)
% Creates a dataset of FBM trajectories with the given variables
%
...
%
%         
% Outputs: - data = dataset of FBM of size num_traj x (t_max+1)
%
...
for aaa = alpha_range    
    ...
    file_name = [path_trajectories 'fbm_alpha_' sprintf('%0.2f', aaa) '.mat'];
